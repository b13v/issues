defmodule Issues.TableFormatter do
  ...
  headers. Prints a tabe to STDOUT of the data from each row 
  indentifed by each header. That is, each header identifies a column, 
  ...
  hyphens, with + sign where the vertical bar between the columns goes.
  ## Example
     iex> widths = [5, 6, 9]
